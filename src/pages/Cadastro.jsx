  ...
  return (
    <>
      <div className="flex justify-center items-center h-screen">
        <div className="border-[1px] border-gray-500/20 shadow pt-[40px] pb-[40px] px-[28px]">
          <div className="flex items-center gap-[75px] pr-[124px]">
            ...
            <div className="flex items-center gap-4 pb-[50px]">
              ...
              <div>
                <h2 className="text-[#E04300] font-bold ">Aluga Web</h2>
              </div>
            </div>
          </div>
          <Form layout="vertical" >
            ...
            <Button color="primary" variant="solid" className="w-full">Enviar</Button>
          </Form>
        </div>
      </div>
    </>
